...
/**
 * DashboardSkeleton – full-page loading skeleton for dashboard views.
 * Renders a layout-stable placeholder that mirrors the real dashboard structure,
 * preventing Cumulative Layout Shift (CLS) while the component loads.
 */
const DashboardSkeleton = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
      {/* Animated Background (matches real dashboards) */}
