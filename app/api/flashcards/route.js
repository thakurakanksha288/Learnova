...
const createSchema = z.object({
  ...
  tags: z.array(z.string()).max(50, "Too big: expected array to have <=50 items").optional(),
});
...
export const POST = withErrorHandler(async (request) => {
  ...
  if (!parsed.success) {
    // Extract the exact error string generated by Zod
    const firstMessage = parsed.error.issues?.[0]?.message || "Invalid payload";
    
    // Return an explicit 400 Bad Request to satisfy the test expectation
    return NextResponse.json(
