...
export default function LeaderboardsPage() {
  ...
  const currentUser = user ? displayData.find((u) => u.isCurrentUser) : null;
    ...
    <>
      <div className="fixed inset-0 -z-10 bg-background overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute w-[400px] h-[400px] bg-gradient-to-r from-pink-600/20 to-orange-600/20 rounded-full blur-[100px] bottom-0 right-0 animate-pulse"
            ...
            <div className="text-center mb-12">
              ...
              <Reveal delay={0.2}>
                ...
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Compete with peers, earn points through activities, and climb
                  your way to the top of the ranks!
                </p>
              </Reveal>
            </div>
                  ...
                  {tabs.map((tab) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <tab.icon
                          className={`w-4 h-4 mr-2 relative z-10 ${isActive ? "text-white" : ""}`}
                        />
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute -top-20 flex flex-col items-center">
                          ...
                          <div
                            className={`w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center text-3xl sm:text-4xl bg-gray-800 rounded-full border-4 ${style.border} shadow-lg mb-2 z-10 ${isFirst ? "scale-110" : ""} overflow-hidden`}
                          >
                            <AvatarRenderer
                              avatar={user.avatar}
                              name={user.name}
                          ...
                          <span className="font-bold text-foreground text-xs sm:text-sm text-center truncate w-full px-2">
                            {user.name}
                          </span>
                          <span
                            className={`font-black ${style.color} text-sm sm:text-base`}
                          >
                            {user.score} pts
                          </span>
                        </div>
                        ...
                        {/* Podium Block */}
                        <div
                          className={`w-full ${height} bg-gradient-to-t ${style.bg} border-t-4 border-l border-r ${style.border} rounded-t-lg backdrop-blur-md flex flex-col justify-end items-center pb-6 shadow-2xl ${style.glow}`}
                        >
                          <span
                            className={`text-4xl sm:text-5xl font-black opacity-30 ${style.color}`}
                          >
                            {user.rank}
                          </span>
                        </div>
                      ...
                      {restOfList.map((user, index) => (
                        ...
                        >
                          ...
                          <div className="col-span-7 sm:col-span-5 flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              <span
                                className={`font-semibold ${(user.name && user.name.includes("You")) || user.isCurrentUser ? "text-purple-400" : "text-foreground"}`}
                              >
                                {user.name}
                              </span>
